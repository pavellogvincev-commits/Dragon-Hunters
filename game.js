...
window.initDraft = function(botCount) {
    ...
    gameState.players = { blue: { name: 'Вы', isBot: false, powers: [1,2,3], avail: [true="selectCaptain('blue', '${opt2.id}')"><div class="captain-title">${opt2.name}</div><div class="captain-desc">${opt2.desc}</div></div>
    `;
